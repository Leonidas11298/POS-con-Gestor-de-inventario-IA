...
export const Sidebar: React.FC<SidebarProps> = ({ activeTab, setActiveTab, onOpenAI, isMobileOpen }) => {
  ...
  const [storeName, setStoreName] = useState('Flup POS');
    ...
    <div className={sidebarClasses}>
      <div className="flex flex-col h-full">
        ...
        <div className="h-20 flex items-center px-8 border-b border-gray-50">
          ...
          <span className="text-xl font-bold text-gray-800 truncate">{storeName}</span>
        </div>
        ...
        <nav className="flex-1 px-4 py-6 space-y-2">
          ...
          {menuItems.map((item) => {
            ...
            return (
              <button
                ...
                className={`w-full flex items-center px-4 py-3 rounded-xl transition-colors duration-200 ${isActive
          ...
          <div className="pt-6">
            ...
            <button
              ...
              className={`w-full flex items-center px-4 py-3 rounded-xl transition-colors duration-200 ${activeTab === Tab.SETTINGS
                ? 'bg-emerald-50 text-emerald-600 font-medium'
                : 'text-gray-500 hover:bg-gray-50 hover:text-gray-700'
                }`}
            >
        ...
        <div className="p-4 border-t border-gray-50">
          <div className="flex items-center">
            ...
            <div className="flex-1">
              <h4 className="text-sm font-semibold text-gray-800">{user?.email?.split('@')[0] || 'Admin'}</h4>
